...
function AddEvent() {
  ...
  const handleSave = () => {
    ...
    console.log("Saving event:", { ...formData, studyPartners, checklist });
    navigate("/events");
  };
    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button
            onClick={handleSave}
            className="bg-[#4CD964] hover:bg-[#4CD964]/90 text-black font-medium"
          >
            ...
            <CardContent className="space-y-4">
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  size="sm"
                  className="bg-[#4CD964] hover:bg-[#4CD964]/90 text-black"
                >
